  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerTitle}>Manage Camera</Text>
        <Text style={styles.headerSubtitle}>Add or Remove Camera</Text>
      </View>
      ...
      <View style={styles.buttonContainer}>
        ...
        <TouchableOpacity style={styles.button}
          onPress={() => navigation.navigate('DeleteCamera')}
        >
          <Text style={styles.buttonText}>Remove Camera</Text>
        </TouchableOpacity>
      </View>
